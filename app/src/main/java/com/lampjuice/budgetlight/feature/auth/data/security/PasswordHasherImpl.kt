package com.lampjuice.budgetlight.feature.auth.data.security
...
class PasswordHasherImpl @Inject constructor() : PasswordHasher {
    ...
    override fun hash(password: String): String = argon2.hash(password).result

    override fun verify(password: String, hash: String): Boolean = argon2.check(password, hash)
}
